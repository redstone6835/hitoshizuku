#!/usr/bin/env python3
"""Extract exact per-syscall aggregates from a profile serial capture."""
...
def main() -> int:
    ...
    try:
        ...
        summary = {
            "schema": "mygo.profile-syscalls.v1",
        ...
        print(f"profile syscall analysis: {error}", file=__import__("sys").stderr)
        return 1
    print(
        "profile syscalls: "
