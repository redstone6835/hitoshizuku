#!/usr/bin/env python3
"""
buildstorm-compiling-split.py

把一次 BuildStorm run 按"首个 Compiling 出现"切成两段分别分析。
...
用法:
    buildstorm-compiling-split.py <run_dir> [--json]
...
def main() -> int:
    ...
    print("=" * 78)
    print("  BuildStorm — Compiling 前/后分段分析")
    print("=" * 78)
