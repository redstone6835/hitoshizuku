...
pub fn register_elm_image_ops(protect: ProtectElmImageRangeFn, sync_icache: SyncElmImageIcacheFn) {
...
pub fn elm_image_ops_registered() -> bool {
    PROTECT_FN.load(Ordering::Acquire) != 0 && SYNC_ICACHE_FN.load(Ordering::Acquire) != 0
}
