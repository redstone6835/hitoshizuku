...
pub use memory::{
    DtbMemoryLayout, DtbMemoryLayoutError, DtbNumaMemoryLayout, DtbNumaMemoryRange,
    DtbResolvedReservedMemory, DtbUefiReservationError, apply_chosen_usable_ranges,
    apply_no_map_granule, described_memory_segments, resolve_memory_layout,
    split_numa_memory_segments, validate_uefi_reserved_memory,
};
pub use reserved::{
