...
impl PciDevice {
    ...
    #[kernel_symbols::export(
        name = "general.dev.pci.PciDevice.pnp_id",
        contract = "kernel.general.pci-device@1",
        version = 1,
        capabilities = kernel_symbols::capability::DEVICE_DISCOVERY
    )]
    ...
    #[kernel_symbols::export(
        name = "general.dev.pci.PciDevice.info",
        contract = "kernel.general.pci-device@1",
        version = 1,
        capabilities = kernel_symbols::capability::DEVICE_DISCOVERY
    )]
    ...
    #[kernel_symbols::export(
        name = "general.dev.pci.PciDevice.try_read_config_u16",
        contract = "kernel.general.pci-config@1",
        version = 1,
        capabilities = kernel_symbols::capability::DEVICE_BUS
    )]
    ...
    #[kernel_symbols::export(
        name = "general.dev.pci.PciDevice.try_write_config_u16",
        contract = "kernel.general.pci-config@1",
        version = 1,
        capabilities = kernel_symbols::capability::DEVICE_BUS,
        flags = kernel_symbols::KERNEL_SYMBOL_FLAG_MUTATES_STATE
    ...
    #[kernel_symbols::export(
        name = "general.dev.pci.PciDevice.try_write_config_u32",
        contract = "kernel.general.pci-config@1",
        version = 1,
        capabilities = kernel_symbols::capability::DEVICE_BUS,
        flags = kernel_symbols::KERNEL_SYMBOL_FLAG_MUTATES_STATE
    ...
    #[kernel_symbols::export(
        name = "general.dev.pci.PciDevice.try_command",
        contract = "kernel.general.pci-config@1",
        version = 1,
        capabilities = kernel_symbols::capability::DEVICE_BUS
    )]
    ...
    #[kernel_symbols::export(
        name = "general.dev.pci.PciDevice.try_set_command",
        contract = "kernel.general.pci-config@1",
        version = 1,
        capabilities = kernel_symbols::capability::DEVICE_BUS,
        flags = kernel_symbols::KERNEL_SYMBOL_FLAG_MUTATES_STATE
    ...
    #[kernel_symbols::export(
        name = "general.dev.pci.PciDevice.bar_count",
        contract = "kernel.general.pci-device@1",
        version = 1,
        capabilities = kernel_symbols::capability::DEVICE_DISCOVERY
    )]
