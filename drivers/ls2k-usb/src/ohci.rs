...
impl OhciHcd {
    pub fn new(base: usize, context: DmaContext) -> Result<Self, &'static str> {
        ...
        hcd.write32(OHCI_HcControl, OHCI_CTRL_CBSR | OHCI_CTRL_HCFS_OPERATIONAL | OHCI_CTRL_RWE);
        Ok(hcd)
    }
    ...
    fn submit_linked(
        ...
        let max_packet = if kind == OhciTransferKind::Control { 8 } else { 64 };
