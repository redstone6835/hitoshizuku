...
/// 环形缓冲区大小（字节），默认 256 KiB，与 Linux 内核日志缓冲区大小相当
...
impl LogBuffer {
    ...
    fn append_text_entry(
        ...
        let message =
            core::str::from_utf8(&message_buf[..msg_len]).unwrap_or("<invalid utf8>");
...
/// 格式化时间戳为 Linux 风格前缀，例如 [    0.123456]
