...
fn resource_descriptor(bytes: &[u8]) -> Result<(Option<Resource>, &[u8]), AmlError> {
    ...
    if bytes[0].get_bit(7) {
        ...
        let descriptor = match descriptor_type {
            0x01 => Err(AmlError::LibUnimplemented),
            0x02 => Err(AmlError::LibUnimplemented),
            0x03 => Err(AmlError::InvalidResourceDescriptor),
            0x04 => Err(AmlError::LibUnimplemented),
            0x05 => Err(AmlError::LibUnimplemented),
            ...
            0x0b => Err(AmlError::LibUnimplemented),
            0x0c => Err(AmlError::LibUnimplemented),
            0x0d => Err(AmlError::LibUnimplemented),
            0x0e => Err(AmlError::LibUnimplemented),
            0x0f => Err(AmlError::LibUnimplemented),
            0x10 => Err(AmlError::LibUnimplemented),
            0x11 => Err(AmlError::LibUnimplemented),
            0x12 => Err(AmlError::LibUnimplemented),
        ...
        let descriptor = match descriptor_type {
            ...
            0x06 => Err(AmlError::LibUnimplemented),
            0x07 => Err(AmlError::LibUnimplemented),
            0x08 => io_port_descriptor(descriptor_bytes),
            0x09 => Err(AmlError::LibUnimplemented),
            0x0A => Err(AmlError::LibUnimplemented),
...
fn address_space_descriptor<T>(bytes: &[u8]) -> Result<Resource, AmlError> {
    ...
    let resource_type = match bytes[3] {
        ...
        192..=255 => return Err(AmlError::LibUnimplemented),
    };
...
pub fn dma_format_descriptor(bytes: &[u8]) -> Result<Resource, AmlError> {
    ...
    let transfer_type_preference = match options.get_bits(0..=1) {
        ...
        3 => return Err(AmlError::InvalidResourceDescriptor),
        _ => unreachable!(),
    };
