...
pub use scheduler::{
    ...
    current_task_on, current_task_ref, defer_timer_tick, drain_deferred_timer_tick, enqueue_task,
    enqueue_task_preferred, enqueue_task_with_hint, group_exit_wakeup, idle_task, init, init_task,
    install_idle, is_cpu_active, is_cpu_online, is_ready, mark_cpu_online, migrate_task,
