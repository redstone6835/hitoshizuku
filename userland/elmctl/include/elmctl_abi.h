...
#define ELM_POLICY_BLOCK_NATIVE_CALL_FAILED (1ull << 37)
...
#define ELM_EBI_SOURCE_FLAG_AUTHORIZE_PRIVILEGED_SYMBOLS (1u << 1)
#define ELM_REPLACE_CELL_FLAG_AUTHORIZE_PRIVILEGED_SYMBOLS (1u << 0)
